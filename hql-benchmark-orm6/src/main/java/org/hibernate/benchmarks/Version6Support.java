 ...
 */
public class Version6Support extends AbstractHibernateVersionSupport {
	...
	protected HqlParseTreeBuilder createHqlParseTreeBuilder() {
		return new ParseTreeBuilderVersion6();
	}

	@Override
	protected HqlSemanticInterpreter createHqlSemanticInterpreter() {
		return new SemanticInterpreterVersion6( (SessionFactoryImplementor) entityManagerFactory );
	}
